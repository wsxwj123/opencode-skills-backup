...
agent-browser connect 9222    # Connect via CDP port
```
...
- **Weekly Installs**: 16.3K
- **Repository**: vercel-labs/agent-browser
- **First Seen**: Jan 16, 2026
- **Installed on**: opencode (12.1K), claude-code (9.7K), cursor (6.8K), gemini-cli (6.3K), codex (6.0K), antigravity (5.7K)
