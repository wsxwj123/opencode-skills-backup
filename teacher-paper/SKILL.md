...
| 层 | 图类型 | 怎么来 |
|----|--------|--------|
| ① 自动生成 | 函数图像、平面几何、数轴、统计图(柱/折/饼/散点)、受力·矢量图 | `figure` 块写 `kind`+参数 → matplotlib 自动画 |
...
**第一轮·定位**：①学段年级（**默认九年级**；小学1-6 / 初中7-9 / 高一~高三）②科目（**默认语文**；文科：语文/英语/政治·道法/历史/地理；理科：数学/物理/化学/生物。**理科要顺带确认配图**：函数/几何/数轴/统计/受力图可自动画；电路图/化学结构/复杂装置图需你提供图片）③考试类型（**默认中考模拟**；单元/月考/期中/期末/学考/高考模拟）
