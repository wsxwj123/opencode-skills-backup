...
| 正文 (Normal) | 宋体 (SimSun) | Times New Roman | 小四 (12pt) | 常规 | 左对齐 | 固定值 20pt | 首行缩进 0.74cm (2字符) | 段前 0，段后 0 |
| 图表题注 (Caption) | 楷体 (KaiTi) | Times New Roman | 五号 (10.5pt) | 常规 | 居中 | 单倍行距 | 无 | 段前 0，段后 12pt |
