...
class FieldConfigManager:
    ...
    def __init__(self, project_config_dir: Optional[Path] = None, user_config_dir: Optional[Path] = None):
        ...
        self.user_config_dir = user_config_dir or Path.home() / ".article-writing" / "configs"
        self.legacy_user_config_dir = Path.home() / ".general-sci-writing" / "configs"
