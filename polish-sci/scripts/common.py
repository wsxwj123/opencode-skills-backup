...
# 保留——顺序影响 marker 输出顺序，可观测。English entries are matched
...
AI_CLICHE_TERMS_EN: tuple[str, ...] = EFFECTIVE_EN["polish-sci"]
AI_CLICHE_TERMS_ZH: tuple[str, ...] = EFFECTIVE_ZH["polish-sci"]
