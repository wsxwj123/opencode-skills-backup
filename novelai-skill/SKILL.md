...
```bash
# 新场景（首次/换场景）
python3 /Users/wsxwj/.claude/skills/novelai-skill/scripts/generate_novelai_image.py \
  --intermediate /Users/wsxwj/resource/workspace/<agent>/intermediate.json \
  --config /Users/wsxwj/.claude/skills/novelai-skill/assets/default_config.json \
...
```bash
python3 /Users/wsxwj/.claude/skills/novelai-skill/scripts/generate_novelai_image.py \
  --intermediate /Users/wsxwj/resource/workspace/lili/intermediate.json \
  --config /Users/wsxwj/.claude/skills/novelai-skill/assets/default_config.json \
  --ratio portrait \
  --agent-name lili \
