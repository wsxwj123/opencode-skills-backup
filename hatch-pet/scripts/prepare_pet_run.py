#!/usr/bin/env python3
"""Create a Claude pet run folder, prompts, and generation job manifest."""
    ...
    jobs: list[dict[str, object]] = [
        {
            ...
            "depends_on": [],
            "generation_skill": "generate_pet_image",
    ...
    for state, _row, frames, _purpose in ROWS:
        ...
        if state == "running-left":
            ...
            derivation_policy = {
                ...
                "fallback_generation_skill": "generate_pet_image",
            }
...
def main() -> None:
    ...
    request = {
        ...
        "primary_generation_skill": "generate_pet_image",
    }
