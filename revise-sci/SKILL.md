...
- After manuscript merge, `reference_sync.py` must append or update the `References/参考文献` section for revision-added citations and emit `reference_sync_report.json`.
